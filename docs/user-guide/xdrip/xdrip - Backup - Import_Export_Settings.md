...
To Backup in Xdrip+ you can do it in a few ways, so  I will show you two of them I use.
<br>
...
but in more recent versions of xdrip+ it is located at <span style="background-color: #FFFF00">**\Internal storage\Download\xDrip-export**</span> which you may need to allow to authorize xDrip+ to access your phone memory.<b>
...
Adding a image with external link
