...
2. Open the Aqara Home app, click the <span style="background-color: #FFFF00">**+**</span> in the upper right corner of the home page, select <span style="background-color: #FFFF00">**Hub E1**</span>, from Adding <span style="background-color: #FFFF00">**Accessory - Gateway/Hub E1**</span> and follow the instructions of the app to operate.<br>
